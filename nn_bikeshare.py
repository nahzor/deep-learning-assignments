class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            final_inputs = np.dot(hidden_outputs, self.weights_hidden_to_output) # 1x1 signals into final output layer
            ...
            error = y - final_outputs #np.mean((y-final_outputs)**2) # 1x1 Output layer error is the difference between desired target and actual output.
            
            output_error_term = error# * final_outputs * (1 - final_outputs) #1x1
            # TODO: Calculate the hidden layer's contribution to the error
            hidden_error = np.dot(self.weights_hidden_to_output, output_error_term) #2x1 . 1x1 = 2x1
            ...
            delta_weights_i_h += X[:, None] * hidden_error_term # 1x1 .  ?????
